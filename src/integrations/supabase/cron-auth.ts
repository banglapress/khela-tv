...
export async function authenticateCronRequest(
  ...
  const currentSecret = process.env['DESK_CRON_SECRET'] || process.env['CRON_SECRET'] || process.env['LOVABLE_CRON_SECRET']
  const previousSecret = process.env['DESK_CRON_SECRET_PREVIOUS'] || process.env['LOVABLE_CRON_SECRET_PREVIOUS']
