...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KhelaTV — খেলাটিভি | বাংলাদেশের খেলা, নির্ভরযোগ্য বাংলায়" },
      { name: "description", content: "KhelaTV / খেলাটিভি — ক্রিকেট, ফুটবল, টেনিস, অ্যাথলেটিক্সসহ বাংলাদেশি ও আন্তর্জাতিক খেলার খবর, বিশ্লেষণ ও ফিচার।" },
      { property: "og:site_name", content: "KhelaTV" },
    ...
    links: [
      ...
      { rel: "canonical", href: "https://khelatv.com/" },
    ],
  }),
